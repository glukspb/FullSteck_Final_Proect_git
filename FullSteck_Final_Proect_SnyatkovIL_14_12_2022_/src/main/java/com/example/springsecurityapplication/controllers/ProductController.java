...
//    }
    ...
    @PostMapping("/search")
    public String productSearch(@RequestParam("search") String search, @RequestParam("ot") String ot, @RequestParam("do") String Do, @RequestParam(value = "price", required = false, defaultValue = "")String price, @RequestParam(value = "contact", required = false, defaultValue = "")String contact, Model model) throws IOException{
...
//        else
        if(!price.isEmpty() & search.isEmpty())
        {
            if(ot.isEmpty() & Do.isEmpty())
            {
                ...
                if(price.equals("sorted_by_ascending_price"))
                {
                    ...
                    else if(contact.equals("videocard")){
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceAsc(5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceAsc(6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceAsc(7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceAsc(8));
                    }
                ...
                else if (price.equals("sorted_by_descending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceDesc(5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceDesc(6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceDesc(7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryOrderByPriceDesc(8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
            ...
            if(!ot.isEmpty() & Do.isEmpty())
            {
                ...
                if(price.equals("sorted_by_ascending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceAsc(Float.parseFloat(ot),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceAsc(Float.parseFloat(ot),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceAsc(Float.parseFloat(ot),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceAsc(Float.parseFloat(ot),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
                ...
                else if (price.equals("sorted_by_descending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceDesc(Float.parseFloat(ot),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceDesc(Float.parseFloat(ot),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceDesc(Float.parseFloat(ot),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOtOrderByPriceDesc(Float.parseFloat(ot),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
            ...
            if(ot.isEmpty() & !Do.isEmpty())
            {
                ...
                if(price.equals("sorted_by_ascending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceAsc(Float.parseFloat(Do),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceAsc(Float.parseFloat(Do),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceAsc(Float.parseFloat(Do),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceAsc(Float.parseFloat(Do),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
                ...
                else if (price.equals("sorted_by_descending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceDesc(Float.parseFloat(Do),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceDesc(Float.parseFloat(Do),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceDesc(Float.parseFloat(Do),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDoOrderByPriceDesc(Float.parseFloat(Do),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
            ...
            if(ot.isEmpty() & Do.isEmpty())
            {
                ...
                System.out.println("contact = " + contact);
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategory(8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("price.isEmpty() && contact.isEmpty()");
            ...
            if(!ot.isEmpty() & Do.isEmpty())
            {
                ...
                System.out.println("contact = " + contact);
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategoryAndOt(Float.parseFloat(ot),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOt(Float.parseFloat(ot),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOt(Float.parseFloat(ot),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndOt(Float.parseFloat(ot),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("price.isEmpty() && contact.isEmpty()");
            ...
            if(ot.isEmpty() & !Do.isEmpty())
            {
                ...
                System.out.println("contact = " + contact);
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByCategoryAndDo(Float.parseFloat(Do),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDo(Float.parseFloat(Do),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDo(Float.parseFloat(Do),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByCategoryAndDo(Float.parseFloat(Do),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("price.isEmpty() && contact.isEmpty()");
            ...
            if(ot.isEmpty() & Do.isEmpty())
            {
                ...
                if(price.equals("sorted_by_ascending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceAsc(search.toLowerCase(), 5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceAsc(search.toLowerCase(), 6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceAsc(search.toLowerCase(), 7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceAsc(search.toLowerCase(), 8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
                ...
                else if (price.equals("sorted_by_descending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceDesc(search.toLowerCase(), 5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceDesc(search.toLowerCase(), 6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceDesc(search.toLowerCase(), 7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryOrderByPriceDesc(search.toLowerCase(), 8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
            ...
            if(!ot.isEmpty() & Do.isEmpty())
            {
                ...
                if(price.equals("sorted_by_ascending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(ot),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(ot),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(ot),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(ot),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
                ...
                else if (price.equals("sorted_by_descending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOtOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(ot),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
            ...
            if(ot.isEmpty() & !Do.isEmpty())
            {
                ...
                if(price.equals("sorted_by_ascending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(Do),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(Do),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(Do),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceAsc(search.toLowerCase(), Float.parseFloat(Do),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
                ...
                else if (price.equals("sorted_by_descending_price"))
                {
                    ...
                    if(contact.equals("furniture")){
                        ...
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(Do),5));
                    }
                    else if(contact.equals("matherboard")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(Do),6));
                    }
                    else if(contact.equals("memory")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(Do),7));
                    }
                    else if(contact.equals("power")){
                        model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDoOrderByPriceDesc(search.toLowerCase(), Float.parseFloat(Do),8));
                    }
                    else if(contact.isEmpty())
                    {
                        System.out.println("!price.isEmpty() && contact.isEmpty()");
        ...
        if(!search.isEmpty() & price.isEmpty())
        {
            ...
            if(ot.isEmpty() & Do.isEmpty())
            {
                ...
                if(contact.equals("furniture")){
                    ...
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategory(search.toLowerCase(), 5));
                }
                else if(contact.equals("matherboard")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategory(search.toLowerCase(), 6));
                }
                else if(contact.equals("memory")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategory(search.toLowerCase(), 7));
                }
                else if(contact.equals("power")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategory(search.toLowerCase(), 8));
                }
                else if(contact.isEmpty())
                {
            ...
            if(!ot.isEmpty() & Do.isEmpty())
            {
                ...
                if(contact.equals("furniture")){
                    ...
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOt(search.toLowerCase(), Float.parseFloat(ot),5));
                }
                else if(contact.equals("matherboard")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOt(search.toLowerCase(), Float.parseFloat(ot),6));
                }
                else if(contact.equals("memory")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOt(search.toLowerCase(), Float.parseFloat(ot),7));
                }
                else if(contact.equals("power")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndOt(search.toLowerCase(), Float.parseFloat(ot),8));
                }
                else if(contact.isEmpty())
                {
            ...
            if(ot.isEmpty() & !Do.isEmpty())
            {
                ...
                if(contact.equals("furniture")){
                    ...
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDo(search.toLowerCase(), Float.parseFloat(Do),5));
                }
                else if(contact.equals("matherboard")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDo(search.toLowerCase(), Float.parseFloat(Do),6));
                }
                else if(contact.equals("memory")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDo(search.toLowerCase(), Float.parseFloat(Do),7));
                }
                else if(contact.equals("power")){
                    model.addAttribute("search_product", productRepository.findByTitleAndByCategoryAndDo(search.toLowerCase(), Float.parseFloat(Do),8));
                }
                else if(contact.isEmpty())
                {
        ...
        if (authentication.getName().equals("anonymousUser")){
            System.out.println("это anonymousUser");
            return "/product/product";
        }else{
